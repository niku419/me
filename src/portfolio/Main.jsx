...
export default function Main() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_rnqs2eh', 'template_fnka29m', e.target, 'user_3xPOwXWxd8NFqX1ltfkao')
      .then((result) => {
          setVariant("primary")
          setAlertContent("Sent Successfully!")
          ...
          setAlertContent("Error sending the message!")
      });
    // setEmail("")
    // setName("")
  ...
  return (
    <div>
      ...
      <Container style={{height: "100vh"}} fluid id="skills" className="skills center-head">
        {/* SKILLS */}
      </Container >
          ...
          <g id="Image">
            <g id="g14">
              <g id="g16">
                ...
                <g id="g62">
                    <path id="path64" d="M107.952 308.508C121.544 366.877 153.477 420.713 197.968 460.267" stroke="#00BBBF" strokeWidth="2.02" strokeMiterlimit="10"/>
                </g>
                <g id="g66">
                ...
                <g id="g70">
                    <path id="path72" d="M633.861 349.129C617.182 393.899 586.452 433.173 547.233 459.836" stroke="#00BBBF" strokeWidth="1.612" strokeMiterlimit="10"/>
                </g>
                <g id="g74">
                    <path id="path76" d="M198.233 424.458C213.177 349.774 197.247 269.251 155.048 206.17" stroke="#11ABBA" strokeWidth="2.541" strokeMiterlimit="10"/>
                </g>
                <g id="g78">
                ...
                <g id="g114">
                    <path id="path116" d="M546.285 450.207C530.11 375.786 544.71 295.004 585.861 231.219" stroke="#11ABBA" strokeWidth="2.541" strokeMiterlimit="10"/>
                </g>
                <g id="g118">
                ...
                <g id="g158">
                    <path id="path160" d="M194.298 545.299C131.158 507.676 73.43 460.749 23.4922 406.451" stroke="#55CDE2" strokeWidth="2.541" strokeMiterlimit="10"/>
                </g>
                <g id="g162">
                ...
                <g id="g166">
                    <path id="path168" d="M558.719 549.691C601.746 514.86 639.767 473.689 671.212 427.878" stroke="#55CDE2" strokeWidth="1.91" strokeMiterlimit="10"/>
                </g>
                <g id="g170">
                ...
                <g id="g260">
                    ...
                    <g id="g368">
                        <path id="path370" d="M565.214 487.805C565.214 477.497 549.034 468.633 538.283 477.531C527.532 468.633 511.352 477.497 511.352 487.805C511.352 487.805 507.872 508.014 538.283 522.676C568.694 508.014 565.214 487.805 565.214 487.805Z" stroke="#FAFAFA" strokeWidth="3.811" strokeMiterlimit="10" strokeLinejoin="round"/>
                    </g>
                    <g id="g372">
          ...
          <div className="panel total-body pb-2 mb-3">
            ...
            <Alert variant={variant} className="p-2 mt-3 mx-3" onClose={() => setShow(false)}>
              <div className="d-flex justify-content-between">
                <div className="inline">{alertContent}</div> 
                <div className="inline">
                  <Button onClick={() => setShow(false)} variant="outline-primary" className="btn-close"/>
                </div>
              </div>
            </Alert>}
